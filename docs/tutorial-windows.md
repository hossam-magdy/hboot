# Tutorial: manual setup of HBoot on Windows

… for easier and faster setup using installer (recommended, as long as it works), see the [main documentation page](../README.md), otherwise, keep reading.
...
- USB disk partition table will be like:
  ![Screenshot](./HBoot-partition-table.png)
...
2. Using “**BOOTICE.exe**” (in “**HBoot-Tools.zip**“), follow the screenshot below (blue marks are optional/changeable):
   ...
   ![Tutorial](./HBoot-tutorial-windows.png)
